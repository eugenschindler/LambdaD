...
<model ref="r:288dd2f2-cd14-4e59-b8dc-31a8dd40b87d(Lambda.structure)">
  ...
  <node concept="1TIwiD" id="4xN$hQcqRrg">
    ...
    <node concept="t5JxF" id="4xN$hQcrzoF" role="lGtFl">
      <property role="t5JxN" value="todo implement scoping only until parent lambda-expression variables, not sibling lamda-expressions in the proof" />
    </node>
  </node>
</model>
